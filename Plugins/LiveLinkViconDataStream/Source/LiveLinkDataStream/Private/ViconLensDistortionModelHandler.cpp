...
FVector2D UViconLensDistortionModelHandler::ComputeUndistortedUV(const FVector2D& InScreenUV) const
{
  ...
  auto NormalizedDistanceFromImageCenter = (InScreenUV - CurrentState.ImageCenter.PrincipalPoint) / CurrentState.FocalLengthInfo.FxFy;
